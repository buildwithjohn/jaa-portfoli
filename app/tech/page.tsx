...
const projects = [
  ...
  { title:"PayLedger",                        cat:"Fintech · Frontend",   tags:["Angular 17","NgRx","RxJS","TypeScript","Chart.js","Angular CDK","Tailwind CSS"],  desc:"Production-grade personal finance dashboard — real-time transaction feed with category tagging, interactive spending analytics charts, budget tracker with threshold alerts, and multi-account balance overview. State managed entirely through NgRx Store, Effects, and Selectors. Reactive filtering with RxJS combineLatest and debounceTime. Built to banking-grade UI standards.", github:"https://github.com/buildwithjohn/payleger",           live:"https://payleger.vercel.app/" },
  { title:"AI CV Builder",                      cat:"Frontend · AI",         tags:["Angular 21","Claude AI Streaming","AI-Powered","TypeScript","Vercel"],              desc:"AI-powered CV builder built with Angular 21 — streams AI-generated CV content in real time using the Claude API, with live preview and export.", github:"https://github.com/buildwithjohn/AI-Powered-CV-Builder", live:"https://ai-powered-cv-builder-six.vercel.app/" },
