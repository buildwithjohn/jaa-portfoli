    ...
    <>
      <motion.nav
        ...
        style={{
          ...
          background: scrolled ? "rgba(var(--bg-raw,5,10,18),0.95)" : "transparent",
      ...
      >
        {/* Logo */}
        <a href="#hero" style={{ fontFamily: "'Syne', sans-serif", fontWeight: 800, fontSize: "1.15rem", color: "var(--text)", textDecoration: "none", letterSpacing: "-0.02em" }}>
          JAA<span style={{ color: "var(--cyan)" }}>.</span>
        </a>

        {/* Desktop links */}
        <ul style={{ display: "flex", gap: "2rem", listStyle: "none", alignItems: "center", margin: 0, padding: 0 }} className="hidden md:flex">
          {links.map((l) => (
            <li key={l.href}>
              <a
                href={l.href}
          ...
          <li>
            <a
              ...
              style={{
                ...
                borderRadius: "6px", transition: "all 0.2s", background: "transparent",
              }}
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "0.6rem" }} className="flex md:hidden">
          ...
          <button
            ...
            style={{ background: "none", border: "none", color: "var(--text)", cursor: "pointer", padding: 2, display: "flex" }}
          >
